package utilslib.list.recyclerview;
...
import utilslib.list.IFooterViewCreator;
import utilslib.list.IListWrapper;

import static utilslib.list.IListWrapper.STATE_INITIAL;
import static utilslib.list.IListWrapper.STATE_LOAD_FAILED;
import static utilslib.list.IListWrapper.STATE_LOAD_MORE;
